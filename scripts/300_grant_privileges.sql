------------------------------------------------------------------------
-- Please replace the username SNOWGRID if you used a different username
------------------------------------------------------------------------
...
grant role product_manager to user SNOWGRID;
grant role data_science to user SNOWGRID;
grant role governance_admin to user SNOWGRID;
