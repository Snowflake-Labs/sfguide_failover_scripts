...
create database if not exists snowflake_ha_monitor;
create database if not exists references;
create schema if not exists references.lookups;
create schema if not exists references.policies;
create schema if not exists references.tags;
...
-- create resource monitor and apply to warehouses that require monitoring
